...
echo "------------------Moving files------------------"
cp /home/runner/work/AutomationTesting/AutomationTesting/docs/docs/SchemaMarkdown/README.md /home/runner/work/AutomationTesting/AutomationTesting/docs
